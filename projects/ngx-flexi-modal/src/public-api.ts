...
export * from './lib/components/modals-outlet/modal-instance/instance-types/component/fm-modal-with-component-instance.component';
...
export * from './lib/extensions/basic/fm-modal-basic.definitions';
export * from './lib/extensions/basic/fm-modal-basic.constants';
export * from './lib/extensions/basic/fm-modal-basic.extension';
export * from './lib/extensions/basic/fm-modal-basic.helpers';
export * from './lib/extensions/basic/components/modal-basic/fm-modal-basic.component';
