...
@Component({
  selector: 'fm-modal-with-template-footer-actions',
  standalone: true,
  imports: [NgTemplateOutlet],
  templateUrl: './fm-modal-with-template-footer-actions.component.html',
  styleUrl: './fm-modal-with-template-footer-actions.component.scss',
...
export class FmModalWithTemplateFooterActionsComponent {
